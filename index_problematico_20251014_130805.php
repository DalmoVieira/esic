...
// Versão híbrida: tenta carregar sistema dinâmico, fallback para estático

$dynamicSystemWorking = false;
$errorMessage = '';

// Tentar carregar sistema dinâmico
try {
    if (file_exists(__DIR__ . '/bootstrap.php')) {
        ob_start(); // Capturar output para verificar se há erros
        require_once __DIR__ . '/bootstrap.php';
        
        if (class_exists('\App\Controllers\PublicController')) {
            $controller = new \App\Controllers\PublicController();
            $controller->index();
            $dynamicSystemWorking = true;
            ob_end_flush(); // Se chegou aqui, sistema dinâmico funcionou
            exit; // Sair do script já que o sistema dinâmico funcionou
        }
        ob_end_clean();
    }
} catch (Exception $e) {
...
// Se chegou aqui, sistema dinâmico não funcionou, usar versão estática
?>
<!DOCTYPE html>
<html lang="pt-BR">
<head>
    ...
    <section class="hero-section text-center">
        <div class="container">
            ...
            <div class="alert alert-warning d-inline-block">
                <i class="bi bi-exclamation-triangle"></i> Sistema em modo compatibilidade - <?= date('d/m/Y H:i:s') ?>
    ...
    <footer class="bg-dark text-white py-4 mt-5">
        <div class="container">
            ...
            <div class="text-center">
                ...
                <?php if ($errorMessage): ?>
                <br><small class="text-muted">Debug: Sistema dinâmico indisponível</small>
                <?php endif; ?>
            </div>
        </div>
    </footer>
        ...
        <div class="toast show" role="alert">
            ...
            <div class="toast-body">
                <small>
                    ...
                    <?php if ($errorMessage): ?>
                    Erro: <?= htmlspecialchars(substr($errorMessage, 0, 50)) ?>...
                    <?php endif; ?>
                </small>
            </div>
        </div>
